...
def lose(lost: bool = True):
    ...
    FinalScore = round(FinalScore, 2) * 1000
...
def buttonClick(gameMap: list, name : str,buttonSet : list):
    ...
    print(f"Casillas totales: {totalCasillas}, casillas cubiertas: {casillasCubiertas}, banderas actuales: {currentFlags} banderas restantes: {remainingFlags}")
    ...
    if buttonSet[buttonHeight][buttonWidth]["text"] == "🚩" or  buttonSet[buttonHeight][buttonWidth]["text"] == "":
        casillasCubiertas +=1
